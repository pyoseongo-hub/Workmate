 ...
 * 사장님이 이 숫자를 보고 급여를 셈하므로 어긋나지 않게 조심해서 계산합니다.
 *
 * ⏱️ 여기서 하는 일은 "근무시간을 세는 것" 까지입니다 (사장님 방침, 2026-09-01).
 *
 *   쉬는 시간을 빼거나, 급여를 셈하거나, 수당을 붙이는 일은 하지 않습니다.
 *   매장마다 셈법이 다르고, 그건 사장님이 판단할 몫입니다.
 *   앱은 "며칠 · 몇 시간" 이라는 사실만 정확히 보여 줍니다.
 *
 *   그래서 근무 자료(types.ts 의 Shift)에 휴게시간 칸을 두지 않았습니다.
 *   여기에 빼는 계산을 더하지 마세요.
 */
