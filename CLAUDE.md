...
## 🌐 올라가 있는 곳 (2026-09-03 배포 완료)

**https://workmate-cww0.onrender.com**

- Render 웹 서비스 `workmate` — Blueprint(`render.yaml`)로 만들었다. 이 브랜치에 push 하면 **저절로 다시 올라간다**
- Neon 프로젝트 `workmate` (싱가포르) — `DATABASE_URL` 은 Render 환경변수에만 있다. 저장소에 적지 않는다
- 무료 플랜이라 15분 안 쓰면 잠든다. 첫 사람이 30초쯤 기다린다
- 다음 할 일은 **홍보** — `docs/홍보-계획.md`
